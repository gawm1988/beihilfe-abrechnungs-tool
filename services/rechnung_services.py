...
def neue_rechnung_erfassen(person_id:int,rechnungssteller:str,datum:str,betrag:str,verwendungszweck:str)->bool:
    betrag = float(betrag.replace(",", "."))
    try:
        rechnungssteller_id = read_rechnungssteller_by_name(rechnungssteller).id
