...
def neue_rechnung_erfassen(person_id: int, rechnungssteller: str, rechnungsdatum: str, betrag: str,
    ...
    rechnungDTO = read_rechnung(db_path, rechnungssteller_id, rechnungsdatum_iso, betrag, verwendungszweck)
    if rechnungDTO:
        return False, "Rechnung existiert bereits."

    create_rechnung(db_path, rechnungssteller_id, rechnungsdatum_iso, betrag, verwendungszweck)
